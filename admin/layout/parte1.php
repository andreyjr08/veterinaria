...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="<?php echo $URL;?>/public/templeates/AdminLTE-3.2.0/index3.html" class="brand-link">
            ...
            <span class="brand-text font-weight-light">ANIMAL TI</span>
        </a>
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="info">
                    <a href="" class="d-block">
                        <b>Bienvenido</b> <br> Sergio Segura
                    </a>
                </div>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?php echo $URL;?>/admin/categorias" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Ver categorias</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo $URL;?>/admin/categorias/create.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?php echo $URL;?>/admin/mascotas" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Ver mascotas</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo $URL;?>/admin/mascotas/create.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo $URL;?>/admin/clientes/create.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
